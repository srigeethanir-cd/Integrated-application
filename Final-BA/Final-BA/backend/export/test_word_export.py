...
def create_sample_workflow_output():
    ...
    user_stories = [
        MockUserStory(
            ...
            dependencies=["US-002"],  # Password reset
            priority="HIGH",
            story_points=5,
            epic_id="EPIC-001",
            feature_id="FEAT-001",
...
def test_word_export():
    """Test the complete Word export workflow."""
    ...
    request = ExportRequest(
        ...
        output_filename="test_user_stories.docx",
    )
    ...
    print("\n[Step 4] Exporting to Word document...")
    ...
    if response.status == "completed":
        ...
        print(f"\n📝 Document Contents:")
        print(f"   ✓ Project title and metadata")
