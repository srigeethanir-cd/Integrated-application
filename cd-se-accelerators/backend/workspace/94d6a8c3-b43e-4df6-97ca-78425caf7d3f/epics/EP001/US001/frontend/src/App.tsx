  ...
  return (
    <div className="h-screen w-screen flex flex-col">
      <header className="h-16 bg-primary text-white p-4 flex justify-between">
        ...
        <button className="bg-secondary text-white p-2 rounded" onClick={() => handleUserStoryClick(userStories[0])}>
          View User Story
        </button>
      </header>
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            <ul className="list-disc pl-4">
              {userStories.map((story, index) => (
                <li key={index} className="text-gray-600 cursor-pointer" onClick={() => handleUserStoryClick(story)}>
                  {story.title}
                </li>
              ))}
            </ul>
      ...
      <footer className="h-16 bg-primary text-white p-4 flex justify-between">
        <p className="text-gray-600">&copy; 2024 User Stories</p>
