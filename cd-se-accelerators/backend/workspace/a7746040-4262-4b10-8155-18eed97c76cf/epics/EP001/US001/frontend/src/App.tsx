  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center">
      ...
      <main className="w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="w-full h-50 bg-secondary flex justify-center items-center">
          <button className="bg-primary text-white font-bold py-2 px-4 rounded">Call to Action</button>
        </div>
        <div className="w-full h-full flex flex-col items-center justify-center">
          {userStories.map((story) => (
            <div key={story.id} className="w-full h-100 bg-white flex justify-center items-center">
              <h3 className="text-lg font-medium text-text" onClick={() => handleUserStoryClick(story)}>{story.title}</h3>
            </div>
          ))}
        </div>
      </main>
