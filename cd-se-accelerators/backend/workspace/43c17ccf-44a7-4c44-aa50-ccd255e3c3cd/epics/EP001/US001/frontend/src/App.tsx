  ...
  return (
    <div className="h-screen w-screen flex flex-col">
      ...
      <div className="h-full w-full flex justify-center items-center">
        <div className="w-80 h-80 bg-white rounded-lg shadow-lg p-4">
          ...
          <input
            ...
            placeholder="Name"
            className="w-full h-10 mb-2 p-2 border border-gray-400 rounded-lg"
          />
          <input
            type="email"
            value={email}
          ...
          <button
            ...
            className="w-full h-10 bg-primary text-white rounded-lg hover:bg-secondary"
          >
            Register
          </button>
          <button
            onClick={handleLogin}
            className="w-full h-10 bg-secondary text-white rounded-lg hover:bg-primary mt-2"
          >
            Login
          </button>
        </div>
      ...
      <footer className="h-16 w-full bg-primary text-white flex justify-center items-center">
        <p className="text-sm font-bold">2023 User Registration</p>
      </footer>
    </div>
  );
};
