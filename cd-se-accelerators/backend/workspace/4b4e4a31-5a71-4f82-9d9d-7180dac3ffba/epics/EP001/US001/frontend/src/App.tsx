    ...
    <div className="h-screen w-screen flex flex-col">
      ...
      <main className="flex-1 overflow-y-scroll">
        <div className="container mx-auto p-4">
          <h2 className="text-xl font-bold mb-4">User Stories List</h2>
          <ul>
            {userStories.map((story) => (
              <li key={story.id} className="mb-4">
                <button className="bg-secondary hover:bg-primary text-white font-bold py-2 px-4 rounded" onClick={() => handleUserStoryClick(story)}>
                  {story.title}
                </button>
              </li>
            ))}
          ...
          {userStory && (
            <div className="mt-8">
              <h2 className="text-xl font-bold mb-4">{userStory.title}</h2>
      ...
      <footer className="h-16 bg-primary text-white flex justify-center items-center">
