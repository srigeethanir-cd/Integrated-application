    ...
    <div className="h-screen w-screen flex flex-col items-center justify-center">
      ...
      <main className="w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="w-full h-100 bg-white flex flex-col items-center justify-center">
          <h3 className="text-xl font-bold text-text">Text Block</h3>
        ...
        <button className="w-343 h-50 bg-primary text-white flex justify-center items-center" onClick={() => handleUserStoryClick(userStories[0])}>
          Call to Action
        </button>
        {userStory && (
