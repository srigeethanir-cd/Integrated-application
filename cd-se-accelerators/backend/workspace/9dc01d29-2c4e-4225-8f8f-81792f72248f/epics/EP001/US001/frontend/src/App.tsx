...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center">
      ...
      <main className="h-full w-full flex flex-col items-center justify-center">
        <div className="w-full h-full overflow-y-scroll">
          {userStories.map((story) => (
            <div key={story.id} className="p-4 border-b border-gray-200 cursor-pointer" onClick={() => handleUserStoryClick(story)}>
      ...
      <footer className="h-10 w-full bg-primary text-white flex justify-center items-center">
