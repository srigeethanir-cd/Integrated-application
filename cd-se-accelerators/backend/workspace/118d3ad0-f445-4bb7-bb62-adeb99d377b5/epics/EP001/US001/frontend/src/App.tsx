  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center">
      ...
      <main className="w-full h-full flex flex-col items-center justify-center">
        <div className="w-full h-200 bg-hero-image flex justify-center items-center">
          <h2 className="text-2xl font-bold text-white">Hero Image</h2>
        </div>
        <div className="w-full h-100 bg-white flex flex-col items-center justify-center">
          <h2 className="text-2xl font-bold text-text">Text Block</h2>
          <p className="text-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet nulla auctor, vestibulum magna sed, convallis ex.</p>
        </div>
        <button className="w-343 h-44 bg-primary text-white flex justify-center items-center" onClick={() => handleUserStoryClick(userStories[0])}>
          Call to Action
        </button>
        {userStory && (
          <div className="w-full h-full flex flex-col items-center justify-center">
            <h2 className="text-2xl font-bold text-text">{userStory.title}</h2>
