        ...
        <div className="container mx-auto p-4">
          ...
          <ul>
            {userStories.map((story) => (
              <li key={story.id} className="mb-4">
                <button className="bg-secondary text-white py-2 px-4 rounded" onClick={() => handleUserStoryClick(story)}>
                  {story.title}
                </button>
              </li>
            ))}
          ...
          {userStory && (
            <div className="mt-4">
              ...
              <h3 className="text-lg font-bold mb-2">Acceptance Criteria:</h3>
              <ul>
