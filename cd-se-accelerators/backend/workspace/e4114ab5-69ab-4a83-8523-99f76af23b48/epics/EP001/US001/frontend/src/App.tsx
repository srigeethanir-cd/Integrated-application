  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center">
      ...
      <main className="w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="w-full h-100 bg-text-block flex justify-center items-center">
          <p className="text-lg font-medium text-text">Text Block</p>
        </div>
        <div className="w-full h-50 bg-call-to-action flex justify-center items-center">
          <button className="bg-primary text-white font-bold py-2 px-4 rounded" onClick={() => handleUserStoryClick(userStories[0])}>
            Call to Action
          </button>
        </div>
        {userStory && (
          <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            <p className="text-lg font-medium text-text">{userStory.description}</p>
          </div>
        )}
      </main>
    </div>
