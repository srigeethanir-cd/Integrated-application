...
def create_application() -> FastAPI:
    ...
    # Mount Story Explorer & Workspace Explorer routes
    try:
        from app.api.v1.workspace_explorer_routes import router as story_explorer_router, workspace_router as ws_explorer_router
        app.include_router(story_explorer_router)
        app.include_router(ws_explorer_router)
    except Exception as e:
        print(f"Warning: Could not import workspace_explorer router: {e}")
