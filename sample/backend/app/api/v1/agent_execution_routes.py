...
class Agent1RunRequest(BaseModel):
    ...
    project_id: Optional[str] = Field(default=None, description="Project ID UUID")
...
def run_agent1(req: Agent1RunRequest) -> Any:
    ...
    p_id = req.project_id or str(uuid.uuid4())
    p_name = req.project_name or "Generated Application"
