...
def test_ut_app_services_userservice_authenticate_user(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['InvalidCredentials', 'get_by_email', 'verify_password']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': False, 'exception_details': False, 'interaction_dependencies': ['get_by_email', 'verify_password'], 'validation': False, 'expectations': ['Password verification or authentication is performed', 'The authentication result or generated token is returned']}
    ...
    target = _resolve_unit_target(module, 'UserService.authenticate_user')
    owner = getattr(target, '__self__', None)
...
def test_ut_app_services_userservice_authenticate_user_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_authenticate_user_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['InvalidCredentials', 'get_by_email', 'verify_password']
    test_variant = 'negative'
    expected_exceptions = ['InvalidCredentials']
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': False, 'exception_details': False, 'interaction_dependencies': ['get_by_email', 'verify_password'], 'validation': False, 'expectations': ['The semantically declared failure is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_authenticate_user_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['InvalidCredentials', 'get_by_email', 'verify_password']
    test_variant = 'exception'
    expected_exceptions = ['InvalidCredentials']
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': False, 'exception_details': False, 'interaction_dependencies': ['get_by_email', 'verify_password'], 'validation': False, 'expectations': ['The declared exception type is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_create_user(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    from unittest.mock import AsyncMock, MagicMock, patch
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['EmailConflict', 'User', 'add', 'get_by_email', 'hash_password']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The repository or database persistence operation is invoked', 'The created or persisted object is returned']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.create_user')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_create_user_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_create_user_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    dependencies = ['EmailConflict', 'User', 'add', 'get_by_email', 'hash_password']
    test_variant = 'negative'
    expected_exceptions = ['EmailConflict']
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The semantically declared failure is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_create_user_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    test_variant = 'exception'
    expected_exceptions = ['EmailConflict']
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The declared exception type is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_delete_user(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    from unittest.mock import AsyncMock, MagicMock, patch
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['UserNotFound', 'delete', 'get_by_id']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': False, 'boolean': True, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['delete'], 'validation': False, 'expectations': ['The callable returns exactly True']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.delete_user')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_delete_user_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_delete_user_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    dependencies = ['UserNotFound', 'delete', 'get_by_id']
    test_variant = 'negative'
    expected_exceptions = ['UserNotFound']
    semantic_assertions = {'authentication': False, 'boolean': True, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['delete'], 'validation': False, 'expectations': ['The semantically declared failure is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_delete_user_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    test_variant = 'exception'
    expected_exceptions = ['UserNotFound']
    semantic_assertions = {'authentication': False, 'boolean': True, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['delete'], 'validation': False, 'expectations': ['The declared exception type is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_get_dashboard(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    from unittest.mock import AsyncMock, MagicMock, patch
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['UserNotFound', 'get_by_id']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': False, 'boolean': False, 'collection': True, 'crud': False, 'exception_details': False, 'interaction_dependencies': [], 'validation': False, 'expectations': ['The returned collection has the expected type and contents']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.get_dashboard')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_get_dashboard_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_get_dashboard_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    test_variant = 'negative'
    expected_exceptions = ['UserNotFound']
    semantic_assertions = {'authentication': False, 'boolean': False, 'collection': True, 'crud': False, 'exception_details': False, 'interaction_dependencies': [], 'validation': False, 'expectations': ['The semantically declared failure is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_get_dashboard_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    test_variant = 'exception'
    expected_exceptions = ['UserNotFound']
    semantic_assertions = {'authentication': False, 'boolean': False, 'collection': True, 'crud': False, 'exception_details': False, 'interaction_dependencies': [], 'validation': False, 'expectations': ['The declared exception type is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_login(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    from unittest.mock import AsyncMock, MagicMock, patch
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['authenticate_user', 'create_access_token']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': False, 'exception_details': False, 'interaction_dependencies': ['authenticate_user', 'create_access_token'], 'validation': False, 'expectations': ['Password verification or authentication is performed', 'The authentication result or generated token is returned']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.login')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_reset_password(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    from unittest.mock import AsyncMock, MagicMock, patch
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['UserNotFound', 'add', 'get_by_id', 'hash_password', 'isdigit']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The repository or database persistence operation is invoked', 'The created or persisted object is returned']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
    ...
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.reset_password')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_reset_password_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_reset_password_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    dependencies = ['UserNotFound', 'add', 'get_by_id', 'hash_password', 'isdigit']
    test_variant = 'negative'
    expected_exceptions = ['UserNotFound', 'ValueError']
    semantic_assertions = {'authentication': True, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The semantically declared failure is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
...
def test_ut_app_services_userservice_reset_password_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_search_users(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.search_users')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_search_users_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_search_users_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_search_users_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_update_user(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    from unittest.mock import AsyncMock, MagicMock, patch
    module = _import_unit_module('app.services', 'app/services.py')
    dependencies = ['UserNotFound', 'add', 'get_by_id']
    test_variant = 'positive'
    expected_exceptions = []
    semantic_assertions = {'authentication': False, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The repository or database persistence operation is invoked', 'The created or persisted object is returned']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
    for dependency in dependencies:
        ...
        if hasattr(module, name):
            ...
            dependency_mocks[dependency] = replacement
            patches.enter_context(patch.object(module, name, replacement))
    target = _resolve_unit_target(module, 'UserService.update_user')
    owner = getattr(target, '__self__', None)
    repository = getattr(owner, 'repository', None)
    if isinstance(repository, MagicMock):
        entity = MagicMock(name='repository_entity')
...
def test_ut_app_services_userservice_update_user_boundary(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
...
def test_ut_app_services_userservice_update_user_negative(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    test_variant = 'negative'
    expected_exceptions = ['UserNotFound']
    semantic_assertions = {'authentication': False, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The semantically declared failure is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
...
def test_ut_app_services_userservice_update_user_exception(dependency_mock, monkeypatch):
    import asyncio
    import builtins
    import hashlib
    import importlib
    ...
    test_variant = 'exception'
    expected_exceptions = ['UserNotFound']
    semantic_assertions = {'authentication': False, 'boolean': False, 'collection': False, 'crud': True, 'exception_details': False, 'interaction_dependencies': ['add'], 'validation': False, 'expectations': ['The declared exception type is raised']}
    if any((any((token in dependency.casefold() for token in ('env', 'environ', 'settings', 'config'))) for dependency in dependencies)):
        monkeypatch.setenv('TESTFORGE_UNIT_TEST', '1')
    patches = ExitStack()
    dependency_mocks = {}
